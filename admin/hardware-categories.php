...
if ($action === 'edit' && $categoryId) {
    ...
    if (!$category) {
        header('Location: hardware-categories.php?error=Category not found');
        exit;
    }
}
...
<head>
    ...
    <title>Hardware Categories - LUSANO Admin</title>
    ...
    <div class="admin-container">
        ...
        <nav class="admin-sidebar" id="sidebar">
            ...
            <div class="sidebar-nav">
                ...
                <div class="nav-section">
                    ...
                    <a href="hardware-categories.php" class="nav-item active">
        ...
        <main class="admin-main">
            <header class="admin-header">
                <div>
                    <h1><?php echo $action === 'add' ? 'Add New' : ($action === 'edit' ? 'Edit' : 'Manage'); ?> Hardware Categories</h1>
                    <p style="color: var(--admin-text-muted); margin: 0;">
                        <?php echo $action === 'list' ? 'Manage hardware product categories and filters' : 'Configure category details and appearance'; ?>
                    </p>
                </div>
                <div class="flex items-center gap-2">
                    ...
                    <?php if ($action === 'list'): ?>
                    <a href="hardware-categories.php?action=add" class="btn btn-primary btn-sm">
                        <i class="fas fa-plus"></i>
                        Add Category
                    </a>
                    <?php else: ?>
                    <a href="hardware-categories.php" class="btn btn-secondary btn-sm">
            ...
            <div class="admin-content">
                ...
                <div class="admin-card">
                    <div class="card-header">
                        <h3 class="card-title">Hardware Categories (<?php echo count($categories); ?>)</h3>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        foreach ($products as $product) {
                                            if (isset($product['categories']) && strpos($product['categories'], $cat['id']) !== false) {
                                                $count++;
                                            }
                                        }
                                        ?>
                                    ...
                                    <td>
                                        <div class="flex gap-2">
                                            <a href="hardware-categories.php?action=edit&id=<?php echo $cat['id']; ?>" 
                ...
                <form id="category-form" data-validate>
                        ...
                        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 1.5rem;">
                            <div class="form-group">
                                ...
                                <input type="text" name="id" class="form-input" required 
                                       ...
                                       placeholder="e.g., door-closers, hinges, cylinders"
                        ...
                        <div class="form-group">
                            ...
                            <div style="display: flex; gap: 1rem; align-items: center;">
                                ...
                                <div id="icon-preview" style="background: var(--admin-primary); color: white; padding: 1rem; border-radius: 0.5rem; width: 60px; height: 60px; display: flex; align-items: center; justify-content: center; font-size: 1.5rem;">
                                    <i class="fas <?php echo $category['icon'] ?? 'fa-wrench'; ?>"></i>
                                </div>
                            </div>
                            <small style="color: var(--admin-text-muted);">FontAwesome icon class (e.g., fa-door-closed, fa-key, fa-tools)</small>
                        </div>
                        
                        <div class="form-group">
                            <label class="form-label">Description *</label>
                            <textarea name="description" class="form-input form-textarea" required 
                                      placeholder="Brief description of this hardware category"><?php echo $category['description'] ?? ''; ?></textarea>
                        </div>
                    ...
                    <div class="admin-card">
                        <div class="card-header">
                            <h3 class="card-title">Popular Hardware Icons</h3>
                        ...
                        <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(100px, 1fr)); gap: 1rem;">
                            <?php
                            $popularIcons = [
                                'fa-door-closed' => 'Door Closers',
                                'fa-arrows-alt-h' => 'Hinges',
                                'fa-key' => 'Cylinders',
                                'fa-hand-paper' => 'Handles',
                                'fa-shield-alt' => 'Security',
                                'fa-tools' => 'Hardware',
                                'fa-lock' => 'Locks',
                                'fa-bolt' => 'Bolts',
                                'fa-screwdriver' => 'Fasteners',
                                'fa-cog' => 'Mechanisms',
                                'fa-hammer' => 'Installation',
                    ...
                    <div class="flex gap-2 justify-between">
                        <a href="hardware-categories.php" class="btn btn-secondary">
    ...
    <script>
        function deleteCategory(id) {
            if (confirm('Are you sure you want to delete this category?')) {
                ...
                fetch('api/hardware-categories.php', {
                    method: 'POST',
                    body: formData
                })
        ...
        document.querySelector('input[name="icon"]')?.addEventListener('input', function() {
            ...
            document.querySelector('#icon-preview i').className = 'fas ' + (iconClass || 'fa-wrench');
        });
        ...
        document.getElementById('category-form')?.addEventListener('submit', function(e) {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    window.location.href = 'hardware-categories.php';
                } else {
